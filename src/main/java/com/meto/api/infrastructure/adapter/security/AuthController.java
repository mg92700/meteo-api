...
import com.meto.api.infrastructure.config.JwtUtil;
...
public class AuthController {
    ...
    public AuthController(AuthenticationManager authenticationManager, UserRepositoryPort userRepository, JwtUtil jwtUtil) {
